      ...
      <FloatingActionBar
        ...
        actions={
          <>
            ...
            <Button size="sm" variant="outline" className="h-8" disabled={bulkBusy} onClick={() => handleBulkStatus(0)}>
              Set Inactive
            </Button>
            <Button size="sm" variant="default" className="h-8 shadow-glow" onClick={() => setBulkEditing(true)}>
              Bulk Edit
            </Button>
          </>
        }
