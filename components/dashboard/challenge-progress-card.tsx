      ...
      <CardContent className="space-y-5 relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-surface-muted/30 border border-border-subtle">
            <div className="text-2xs text-text-muted mb-2 uppercase tracking-wider">Profit Target</div>
            <CircularProgress value={m.profit_progress} size={70} strokeWidth={5} tone="success">
              <span className="text-xs font-bold tabular text-success">{fmtPct(m.current_profit_pct, 1, true)}</span>
            </CircularProgress>
