...
import {
  ...
  Users, CreditCard, Layers, BarChart3, SlidersHorizontal, PanelLeftClose, PanelLeftOpen, Mail, Megaphone, Ticket, Users2, HeartPulse, Rocket, Gauge, Palette,
} from 'lucide-react'
...
const ADMIN_NAV: NavItem[] = [
  ...
  { href: '/dashboard/admin/support',    label: 'Helpdesk',   icon: LifeBuoy },
